                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="p-2 rounded-lg bg-blue-50 text-brand-800">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Z" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-6 pt-2 sm:flex-row">
                        ...
                        <div className="relative flex items-center justify-center shrink-0 w-36 h-36">
                            <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                                {/* Círculo base fondo */}
                                <path className="text-slate-100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-width="4.5"></path>
                                {/* Operadores 72% (#1e40af / brand-800) */}
                                <path className="text-brand-800" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="72, 100" stroke-linecap="round" stroke-width="4.5"></path>
                                {/* Supervisores 19% (#38bdf8 / sky-400) offset 72 */}
                                <path className="text-sky-500" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="19, 100" stroke-dashoffset="-72" stroke-linecap="round" stroke-width="4.5"></path>
                                {/* Administradores 9% (#64748b / slate-500) offset 91 */}
                                <path className="text-slate-400" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="9, 100" stroke-dashoffset="-91" stroke-linecap="round" stroke-width="4.5"></path>
                            </svg>
                ...
                <div className="flex flex-col justify-between p-6 bg-white border shadow-sm lg:col-span-5 rounded-xl border-slate-200/90">
                    <div>
                        ...
                        <button className="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-semibold text-white transition rounded-lg shadow-sm bg-brand-800 hover:bg-brand-900 focus:ring-2 focus:ring-offset-2 focus:ring-brand-800" type="button">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="mt-4 space-y-2">
                            <button className="w-full flex items-center justify-between px-3.5 py-2 rounded-lg border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition text-left" type="button">
                                <span className="flex items-center gap-2.5">
                                    <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75Z" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                            ...
                            <button className="w-full flex items-center justify-between px-3.5 py-2 rounded-lg border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition text-left" type="button">
                                <span className="flex items-center gap-2.5">
                                    <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25Z" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                            ...
                            <button className="w-full flex items-center justify-between px-3.5 py-2 rounded-lg border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition text-left" type="button">
                                <span className="flex items-center gap-2.5">
                                    <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.25V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                ...
                                <td className="py-3.5 px-6 whitespace-nowrap text-right">
                                    <div className="flex items-center justify-end gap-1">
                                        <button className="p-1.5 text-slate-400 hover:text-brand-800 hover:bg-slate-100 rounded-md transition" title="Editar usuario" type="button">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
