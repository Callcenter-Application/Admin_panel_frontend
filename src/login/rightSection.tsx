...
export const RightSection = () => <section className="flex flex-col justify-between overflow-y-auto border-l border-outline-variant/40 bg-surface-container-low p-8 sm:p-12 lg:col-span-7 lg:p-16">
    <div className="mx-auto my-auto w-full max-w-md">
        ...
        <div
            id="alert-banner"
            className="hidden items-start gap-3 rounded-lg border border-error/20 bg-error-container p-3 text-on-error-container"
            role="alert"
        >
            <span
            className="material-symbols-outlined mt-0.5 shrink-0 text-lg text-error"
            data-icon="error"
            >
            error
            </span>
        ...
        >
            ...
            <div className="relative rounded-lg shadow-sm">
                ...
                required
                className="block w-full rounded-lg border border-outline-variant bg-surface-container-lowest py-2.5 pl-10 pr-3 text-on-surface placeholder:text-outline transition duration-150 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-secondary"
                />
            </div>
            ...
            <div className="flex items-center justify-between">
                ...
                <a
                href="#"
                className="font-label-md text-sm text-secondary transition-colors hover:text-primary hover:underline"
                >
            ...
            <div className="relative rounded-lg shadow-sm">
                ...
                required
                className="block w-full rounded-lg border border-outline-variant bg-surface-container-lowest py-2.5 pl-10 pr-10 text-on-surface placeholder:text-outline transition duration-150 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-secondary"
                />
                ...
                className="absolute inset-y-0 right-0 flex items-center pr-3 text-outline hover:text-on-surface focus:outline-none"
            ...
            <label className="flex cursor-pointer items-center gap-2.5">
                ...
                name="remember"
                type="checkbox"
                className="h-4 w-4 rounded border-outline-variant text-primary-container transition focus:ring-secondary focus:ring-offset-0"
                />
            ...
            id="submit-btn"
            type="submit"
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 font-label-lg text-sm font-semibold text-on-primary shadow-sm transition-all duration-150 hover:bg-primary-container active:scale-[0.99]"
            >
